...
export default function OrderPage() {
    ...
    return (
        <section className="mx-auto max-w-lg px-4 sm:px-6 lg:px-8 min-h-screen flex items-center justify-center flex-col">
            <button onClick={() => router.back()} className="w-48 hover:w-full hover:px-3 hover:py-3 mb-1 transition-all ease-in duration-500 flex items-center justify-center rounded-md border border-transparent py-2 text-base font-medium text-orange-600 shadow-sm bg-orange-100 sm:px-2"><ArrowBackIosNewRounded /></button>
